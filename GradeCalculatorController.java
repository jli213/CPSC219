...
public class GradeCalculatorController {
    ...
    void calculateGrade(ActionEvent event) {
    	...
    	courseGrade += (requiredCodingChallengesPassed*100/15)*0.6*15/20;
    	...
    	courseGrade += (optionalCodingChallengesPassed*100/5)*0.6*5/20;
